...
public class LuceneHelper {
    ...
    public long addIndex(String index, Document document) {
        try {
            String indexDir = properties.getIndexDir() + File.separator + index;
    ...
    public long deleteIndex(String index, Term condition) {
        try {
            String indexDir = properties.getIndexDir() + File.separator + index;
            //打开索引目录
            Directory directory = FSDirectory.open(Paths.get(indexDir));
    ...
    public long updateIndex(String index, Document document, Term condition) {
        try{
            String indexDir = properties.getIndexDir() + File.separator + index;
