<template>
    ...
    <el-affix :offset="0">
        <div class="bg-white h-[64px] flex pr-4 border-b border-slate-100">
            ...
            <div class="ml-auto flex">
                ...
                <!-- 点击返回主页 -->
                <el-tooltip class="box-item" effect="dark" content="主页" placement="bottom">
                    <div class="w-[42px] h-[64px] cursor-pointer flex items-center justify-center text-gray-700 mr-2 hover:bg-gray-200"
                        @click="backHome">
                        <el-icon>
                            <House />
                ...
                <el-dropdown class="flex items-center justify-center" @command="handleCommand">
                    <span class="el-dropdown-link flex items-center justify-center text-gray-700 text-xs">
                        <!-- 头像 Avatar -->
                        <el-avatar :size="25" :src="blogSettingStore.blogSettings.avatar" />
    ...
    <!-- 修改密码 -->
    <FormDialog ref="formDialogRef" title="修改密码" destroyOnClose @submit="onSubmit" confirmText="更新">
        <el-form ref="formRef" :rules="rules" :model="form">
            <el-form-item label="用户名" prop="username" label-width="80px" size="large">
            ...
            <el-form-item label="确认新密码" prop="rePassword" label-width="80px">
...
const blogSettingStore = useBlogSettingsStore()
// 表单引用
