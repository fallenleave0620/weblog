        ...
        <nav class="bg-white border-gray-200 border-b dark:bg-gray-900 dark:border-gray-800">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <a href="/" class="flex items-center">
                    <img :src="blogSettingsStore.blogSettings.logo" class="h-8 w-8 mr-3 rounded-full"
                        alt="Flowbite Logo" />
                ...
                <div class="flex items-center md:order-2">
                    ...
                    <button class="ml-1 mr-4 vt-switch vt-switch-appearance inline-block" @click="toggleDark()" type="button" role="switch"
                        aria-label="切换深色模式" aria-checked="false" data-v-d401ce6f=""><span class="vt-switch-check"><span
                                class="vt-switch-icon"><!--[-->
                                <!-- 太阳图标 -->
                                <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false"
                                    viewBox="0 0 24 24" class="vt-switch-appearance-sun" :class="[isDark ? 'hidden' : 'block']">
                                    <path
                                ...
                                <!-- 黑夜图标 -->
                                <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false"
                                    viewBox="0 0 24 24" class="vt-switch-appearance-moon" :class="[isDark ? 'block' : 'hidden']">
                                    <path
                    ...
                    <div class="relative hidden mr-2 md:block">
                        ...
                        <!-- 搜索框 -->
                        <button type="button" @click="clickModalVisible"
                            class="m-2 hidden outline-none md:flex  items-center text-sm leading-6 text-slate-400 rounded-md ring-1 ring-slate-900/10 shadow-sm py-1.5 pl-2 pr-3 hover:ring-slate-300 dark:bg-slate-800 dark:hover:bg-slate-700 dark:hover:ring-slate-700">
                            ...
                            <span class="px-2 py-[1px] flex-none text-xs border text-gray-400 rounded dark:border-gray-600">Ctrl Shift
                                K</span>
                        </button>
                    </div>
                    ...
                    <div id="dropdown"
                        ...
                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                            ...
                            <li @click.prevent="router.push('/admin/index')">
                                <a href="#"
                ...
                <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
                    <div class="relative mt-3 md:hidden">
                        <!-- 移动端搜索框 -->
                        <button type="button" @click="clickModalVisible" class="relative mt-3 flex w-full md:hidden items-center text-sm leading-6 text-slate-400 rounded-md
                    ...
                    <ul
                        ...
                        <li>
                            <a @click="router.push('/')"
                                ...
                                class="cursor-default block py-2 pl-3 pr-4 rounded md:rounded-none hover:bg-gray-100 md:hover:bg-transparent md:hover:text-sky-600 md:bg-transparent md:p-0 dark:hover:bg-gray-700 md:dark:hover:bg-transparent"
                        ...
                        <li>
                            <a @click="router.push('/category/list')"
                                ...
                                class="cursor-default block py-2 pl-3 pr-4 rounded md:rounded-none hover:bg-gray-100 md:hover:bg-transparent md:hover:text-sky-600 md:p-0 md:dark:hover:text-sky-500  dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">分类</a>
                        </li>
                        <li>
                            <a @click="router.push('/tag/list')"
                                ...
                                class="cursor-default block py-2 pl-3 pr-4 rounded md:rounded-none hover:bg-gray-100 md:hover:bg-transparent md:hover:text-sky-600 md:p-0 md:dark:hover:text-sky-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">标签</a>
                        </li>
                        <li>
                            <a @click="router.push('/archive/list')"
                                ...
                                class="cursor-default block py-2 pl-3 pr-4 rounded md:rounded-none hover:bg-gray-100 md:hover:bg-transparent md:hover:text-sky-600 md:p-0 md:dark:hover:text-sky-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">归档</a>
                        </li>
        ...
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                ...
                <div
                    ...
                    <form class="w-full">
                        <label for="search"
                            class="w-full mb-2 text-sm font-medium text-gray-900 sr-only dark:text-white">Search</label>
                        <!-- 搜索图标 -->
                        <div class="relative">
                            <!-- loading图标 -->
                            ...
                            <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none" v-else>
                                <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-width="2" d="m19 19-4-4m0-7A7 7 0 1 1 1 8a7 7 0 0 1 14 0Z" />
                    ...
                    <button type="button" @click="clickCloseBtn"
                ...
                <div class="p-4 md:p-5 space-y-4">
                    <div v-if="searchArticles && searchArticles.length > 0">
                        ...
                        <ol class="mt-3 divide-y divider-gray-200 dark:divide-gray-600">
                            <li v-for="(article, index) in searchArticles" :key="index"><a
                                    @click="jumpToArticleDeatailPage(article.id)"
                                    class="items-center block p-3 sm:flex hover:bg-gray-100 hover:rounded-lg dark:hover:bg-gray-700"><img
                                        class="w-24 h-12 mb-3 mr-3 rounded-lg sm:mb-0 dark:divide-gray-600" :src="article.cover">
...
const clickModalVisible = () => {
    searchModal.value.show();
    searchInputRef.value.focus();
    // searchInputRef.value = searchWord
}
const clickCloseBtn = () => {
...
// 点击搜索结果，跳转文章详情页
const jumpToArticleDeatailPage = (articleId) => {
    // 隐藏搜索对话框
    searchModal.value.hide();
    //路由跳转
