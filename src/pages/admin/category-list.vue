<template>
    <div>
        ...
        <el-card shadow="never">
            ...
            <FormDialog ref="formDialogRef" title="添加文章分类" destroyOnClose @submit="onSubmit" confirmText="添加">
            ...
            <!-- 输入框组件 -->
            <!-- <el-input size="large" v-model="form.name" placeholder="请输入分类名称" maxlength="20" clearable
                            show-word-limit />
                    </el-form-item>
                </el-form>
                <template #footer>
