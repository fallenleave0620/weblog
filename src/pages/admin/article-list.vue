<template>
    <div>
            ...
            <el-table :data="tableData" border stripe style="width: 100%" v-loading="tableLoading">
                ...
                <el-table-column label="操作">
                    <template #default="scope">
                        ...
                        <el-button size="small" @click="goArticleDetail(scope.row.id)">
                            <el-icon class="mr-1">
                                <View />
                            </el-icon>
                            预览
        ...
        <el-dialog v-model="isArticlePublishEditorShow" :fullscreen="true" :show-close="false" width="500">
        ...
        <!-- 编辑博客 -->
        <!-- :close-on-press-escape="false" 属性，防止用户可以通过 Esc 键来隐藏对话框，限制了用户必须点击取消按钮才能隐藏对话框，保持 UI 交互的统一性。 -->
...
getCategorySelectList().then((e) => {
    ...
    // console.log('获取分类数据：' + JSON.stringify(e.data))
})
